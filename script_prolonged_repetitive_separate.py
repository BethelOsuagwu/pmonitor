...
linear_relief_time=3*60*60; # Relief time in seconds
...
tissueLinear=TissueLinear('default-c',ptt,ee,linear_beta,linear_beta,linear_beta);
...
title='Repetitive input response (mean pressure:'+str(round(np.mean(Ps)))+'kPa),'
xlabel='Time (h)';
ylabel='Effect * s';
...
file_name='img/separate/prolonged/prolonged_repetitive_compare_separate.pdf';
