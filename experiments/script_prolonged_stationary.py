...
relief_time=20*60; # Reliefe time in seconds
...
plt.legend(lines0+lines2+lines4,['Pressure','TissueBinned','Averaging $x10^{-4}$'],loc=2);
plt.title('Stationary input response (mean pressure:'+str(round(np.mean(Ps)))+'kPa),')
plt.savefig('img/prolonged/prolonged_stationary.pdf')
