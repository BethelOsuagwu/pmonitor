...
tissueBinned=TissueBinned('default-b',ptt,ee,beta,beta,beta);
tissueSpecial=TissueSpecial('default-s',ptt,ee,beta,beta,beta);
...
plt.legend(lines0+lines1+lines2+lines3+lines4,['Pressure','Tissue','TissueBinned','TissueSpecial','Averaging $x10^{-3}$'],loc=9);
plt.title('Sinusoidal response')
plt.savefig('img/sinusoidal_input_response.pdf')
