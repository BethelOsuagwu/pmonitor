...
ax1.set_ylabel('Effect * s (x $10^{-3}$)')
...
plt.legend(lines0+lines1+lines2+lines3+lines4,['Pressure','TissueFixed','TissueInverse','TissueContinuous','Averaging $x10^{-3}$'],loc=9);
plt.title('Sinusoidal response')
plt.savefig('img/sinusoidal_input_response_compare.pdf')
